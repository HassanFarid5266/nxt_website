...
var i = setInterval(function () {
  var counterElement = document.querySelector(".loading-page .counter .count");
...
document.getElementById("burger-menu-btn").addEventListener("click", function (e) {
  ...
  if (sidebar.classList.contains("active")) {
    ...
    target.classList.add("close-icon");
...
function url(name, params = null) {
  ...
  return `${window.location.origin}/api/method/nextash_cloud.${name}` + query;
}
