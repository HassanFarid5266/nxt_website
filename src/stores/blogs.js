...
export const useBlogsStore = defineStore('blogs', () => {
  ...
  const blogs = ref([
    { 
      ...
      blogger: 'NexTash', 
      blog_intro: 'In today\'s fast-paced and ever-evolving digital landscape, the traditional waterfall approach to software development is no longer sufficient to meet the demands of modern businesses.', 
      category: 'Product', 
    ...
    { 
      ...
      blogger: 'NexTash', 
      blog_intro: 'In the world of user experience, understanding the nuances of human behavior is crucial for creating intuitive interfaces. UX design isn\'t just about aesthetics—it\'s about understanding how users interact with products and designing interfaces that are not only visually appealing but also functional and easy to use.', 
      category: 'Design', 
    ...
    { 
      ...
      blogger: 'NexTash', 
      blog_intro: 'The cloud computing landscape is ever-evolving, and staying ahead of the curve requires a strategic approach to cost optimization. While cloud services offer tremendous flexibility and scalability, managing costs can be a significant challenge for businesses. This blog explores best practices for optimizing cloud spend and maximizing the value of cloud investments.', 
      category: 'Cloud', 
